	...
	var glDatePicker = (function() {
		...
		glDatePicker.prototype =
		{
			...
			render: function(renderCalback) {
				...
				var selectableYears = getSelectableList(todayVal.year - 50, todayVal.year + 30, options.selectableYears);
				...
				var containerWidth = options.pickerWidth || el.outerWidth();
