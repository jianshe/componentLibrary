...
define(['jquery'], function($) {
    ...
    var _generateHtml = function() {
        ...
        if (_page === _pages) {
            s.push('<li class="disabled"><a href="javasctipt:void(0);" aria-label="下一页">下一页<span aria-hidden="true">&raquo;</span></a></li>');
        } else {
            s.push('<li data-page="' + (_page + 1) + '" class="js-page"><a href="javasctipt:void(0);" aria-label="下一页">下一页<span aria-hidden="true">&raquo;</span></a></li>');
        }
